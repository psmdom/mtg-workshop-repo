    ...
    createModal() {
      ...
      this.modal.innerHTML = `
        <div class="${CLASS.popup}">
          <h2>CHANGE HERE!</h2>
          <p>CHANGE HERE (CURRENT GAME SCORE): <span id="${ID.finalScore}">0</span></p>
          <p>CHANGE HERE (TOTAL SCORE) : <span id="${ID.totalScore}">0</span></p>
          <button id="${ID.playAgain}" class="${CLASS.button}">CHANGE HERE (PLAY AGAIN)</button>
        </div>
      `;
