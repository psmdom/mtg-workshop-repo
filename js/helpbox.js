    ...
    createModal() {
      ...
      this.modal.innerHTML = `
        <div class="helpbox-content">
          ...
          <h2 id="helpbox-title">CHANGE HERE</h2>
          <img 
            src="/images/bg/mtg_helpbox.png" // CHANGE HERE
            alt="Maori Keyboard Map" 
            loading="lazy" 
            class="keyboard-map"
          />
          <button id="helpbox-ok" class="btn mt-2" aria-label="Start Game">CHANGE HERE</button>
        </div>
      `;
